            ...
            <div className="container mx-auto px-4">
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        ...
                        {/* Floating Glass Code Slab */}
                        <div className="absolute inset-0 flex items-center justify-center p-6">
                            <div className="w-full max-w-md bg-black/40 backdrop-blur-xl rounded-3xl overflow-hidden border border-white/10 shadow-2xl transform transition-transform hover:-translate-y-2 duration-500">
                                {/* Header / Status Bar */}
                                <div className="px-6 py-4 flex items-center justify-between border-b border-white/5 bg-white/5">
                                    <div className="flex items-center gap-3">
                                        <div className="w-2 h-2 rounded-full bg-violet-400 animate-pulse" />
                                        <span className="text-xs font-medium tracking-widest text-violet-200 uppercase">System.Core</span>
                                    </div>
                                ...
                                <div className="p-8 font-mono text-sm leading-loose">
                                    ...
                                    <div className="text-violet-300">interface <span className="text-white font-bold">DigitalExcellence</span> <span className="text-white/40">{`{`}</span></div>

                                    <div className="pl-6 border-l border-white/5 my-2 space-y-2">
                                        <div>
                                            <span className="text-cyan-400">input</span>: <span className="text-emerald-300">&quot;Academic_Rigor&quot;</span>;
                                        </div>
                                        <div>
                                            <span className="text-cyan-400">process</span>: <span className="text-emerald-300">&quot;Premium_Dev&quot;</span>;
                                        </div>
                                        <div>
                                            <span className="text-cyan-400">output</span>: <span className="text-emerald-300">&quot;Market_Leader&quot;</span>;
                                        </div>
                                    </div>

                                    <div className="text-white/40">{`}`}</div>

                                    <div className="mt-8 flex items-center gap-3 text-xs text-emerald-400 bg-emerald-500/10 p-3 rounded-lg border border-emerald-500/20">
